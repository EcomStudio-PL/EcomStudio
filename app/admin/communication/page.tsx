...
/**
 * SKRZYNKA — the shop's mailbox, first tab of the communication module.
 *
 ...
 */
export default async function CommunicationInbox() {
  ...
  // the screen says it once instead and points at the fix — which is now a tab
  // away rather than in another part of the menu.
  ...
  if (!configured) {
    return (
      <EmptyState
        ...
        action={
          <Link
            href="/admin/communication/kanaly"
  ...
  return <MailClient address={mail.config.email} />;
}
