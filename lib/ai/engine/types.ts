...
export const REFERENCE_ROLES = [
  "PRIMARY_REFERENCE", "PRIMARY_GEOMETRY", "FRONT_DETAIL", "SIDE_PROFILE",
  "REAR_DETAIL", "BACK_DETAIL", "MATERIAL", "BUTTON_LAYOUT", "PORT_LAYOUT",
  "BRANDING", "DIMENSIONS", "SCALE", "ACCESSORIES", "USAGE", "COLOR",
  "MECHANISM", "SCENE_ONLY",
] as const;
