...
<body style="margin:0; padding:0; background-color:#F4EFF9;" bgcolor="#F4EFF9">
  ...
  <div style="display:none; max-height:0; overflow:hidden; mso-hide:all; font-size:1px; line-height:1px; color:#F4EFF9;">
    Potwierdź adres e-mail i aktywuj swoje konto GrovBase.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
  </div>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td align="center" style="padding:0 8px 28px 8px; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:15px; line-height:24px; color:#4A4058;">
                    Twoje konto GrovBase jest prawie gotowe.<br>
                    Kliknij przycisk poniżej, aby potwierdzić adres e-mail i&nbsp;aktywować konto.
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" bgcolor="#D628CF" style="background-color:#D628CF; background-image:linear-gradient(135deg, #D628CF 0%, #F950E1 100%); border-radius:10px;">
                          <a href="https://grovbase.com/auth/confirm?token_hash={{ .TokenHash }}&type=email" target="_blank" style="display:inline-block; padding:16px 40px; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:14px; line-height:18px; font-weight:700; letter-spacing:0.6px; color:#FFFFFF; text-decoration:none; border-radius:10px;">POTWIERDŹ ADRES E-MAIL</a>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <!-- Box korzysci -->
                <tr>
                  <td bgcolor="#FAF5FE" style="background-color:#FAF5FE; border:1px solid #F0E3F8; border-radius:12px; padding:18px 22px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="padding:0 0 8px 0; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13px; line-height:19px; font-weight:700; color:#1A1127;">
                          Po aktywacji konta możesz korzystać z:
                        </td>
                      </tr>
                      <tr>
                        <td style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13px; line-height:22px; color:#4A4058;">
                          <span style="color:#D628CF;">•</span>&nbsp; generatora zdjęć produktowych<br>
                          <span style="color:#D628CF;">•</span>&nbsp; Product Lock<br>
                          <span style="color:#D628CF;">•</span>&nbsp; narzędzi edycji<br>
                          <span style="color:#D628CF;">•</span>&nbsp; biblioteki GrovBase
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td align="center" style="padding:24px 8px 0 8px; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#8A7E99;">
                    ...
                    <a href="https://grovbase.com/auth/confirm?token_hash={{ .TokenHash }}&type=email" target="_blank" style="color:#D628CF; text-decoration:underline; word-break:break-all;">https://grovbase.com/auth/confirm?token_hash={{ .TokenHash }}&type=email</a>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding:0 8px 0 8px; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:12px; line-height:19px; color:#8A7E99;">
                    Jeżeli to nie Ty tworzyłeś konto, możesz zignorować tę wiadomość.
                  </td>
                </tr>
