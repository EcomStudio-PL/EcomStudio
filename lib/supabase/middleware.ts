...
const PROTECTED_PREFIXES = ["/home","/dashboard","/generator","/library","/prompts","/history","/credits","/plan","/settings","/profile","/admin","/podglad","/tools","/inspirations","/support","/k","/retusz","/wideo","/grovnews"];
